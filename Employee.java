...
public class Employee
{
    ...
    */
    ...
    {
        return (name.equals(otherEmployee.name) //overloading an equals method
                       && hireDate.equals(otherEmployee.hireDate));
    }
  
   
    
    public boolean equals(Object otherObject) //overWRITING an equals method
    {
      if(otherObject == null)
        return false;
      else if(!(otherObject instanceof Employee)) //compares both and asks if otherObject is an employee object
        return false;
      else
      {
        Employee otherEmployee = (Employee)otherObject; //casts otherObject as an actual employee
